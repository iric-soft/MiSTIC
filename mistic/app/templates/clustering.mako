...
require([
    ...
    cluster_roots = node.Node.fromMST(nodes, edges);

    current_graph = new arcplot.arcplot($('#graph'), {
    ...
    var exact_nc_w = function(n11, n12, n21, n22) {
        ...
        var a = -Math.log(math.stats.fisher.exact_nc (n11, n12, n21, n22, 2));
    ...
    $('#dataset_cmp').on('change', function(event) {
        ...
        if (val == '') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    var node_content = [];
                    _.each(node.Node.fromMST(data[0], data[1]), function(root) {
                        var new_root = root.collapse(current_graph.options.cluster_minsize);
                        new_root.collapseUnbranched();
                        var n, p;
                        for (p = new node.PostorderTraversal(new_root); (n = p.next()) !== null; ) {
                    ...
                    current_graph.colourByClusterMatch(
                        ...
                        function (a, b, c, d, ignored) {
                            return Math.max(0.0, math.stats.kappa(a, b, c, d));
                        },
                        function (a,b) {
                            return a > b;
                        },
            ...
            success: function(data) {
                ...
                current_graph.colourByClusterNumber(
                    ...
                    function (a,b,c,d) {
                        ...
                        return math.stats.chi2_yates(a, b, c, d);
                    },
                    function (a,b) {
                        return a > b;
                    },
